...
heading=Label(t,text='Delete - Call Closing', font=('helvetica',14))
...
def deletecallclosing():
    ...
    sql = "delete from callclosing where callno ='%s'" %(xa)
    
    cur.execute(sql)
    db.commit()
    
    messagebox.showinfo('Hi','Call Closing Deleted')
...
delete=Button(t,text='Delete',command=deletecallclosing)
