...
heading=Label(t,text='Delete Feedback', font=('helvetica',14))
...
def deletefeedback():
    ...
    sql = "delete from feedback where callno ='%s'" %(xa)
    
    cur.execute(sql)
    db.commit()
    
    messagebox.showinfo('Hi','Feedback Deleted')
...
"""
delete=Button(t,text='Delete',command=deletefeedback)
