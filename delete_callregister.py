...
heading=Label(t,text='Delete - Registered Call', font=('helvetica',14))
...
def deletecallregister():
    ...
    sql = "delete from callregister where callno ='%s'" %(xa)
    
    cur.execute(sql)
    db.commit()
    
    messagebox.showinfo('Hi','Call Register Deleted')
...
delete=Button(t,text='Delete',command=deletecallregister)
