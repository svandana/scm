...
heading=Label(t,text='Delete Service Centre', font=('helvetica',14))
...
def deletecentre():
    ...
    sql = "delete from servicecentre where centreid ='%s'" %(xa)
    
    cur.execute(sql)
    db.commit()
    
    messagebox.showinfo('Hi','Service Centre Deleted')
...
delete=Button(t,text='Delete',command=deletecentre)
